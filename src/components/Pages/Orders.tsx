    ...
    <>
      <div className="relative lg:grid md:grid grid-cols-11">
        ...
        <div className="lg:col-span-9 md:col-span-10 lg:p-8 p-3">
          ...
          {/* Orders */}
          <div className="grid lg:grid-cols-12 md:grid-cols-12 grid-cols-4 gap-x-5 lg:gap-y-0 md:gap-y-0 gap-y-5 hero-bg text-black lg:px-2 md:px-2 px-4 pt-2 bg-white rounded shadow mb-3">
            {/* Shoes */}
            <div className="col-span-2 rounded">
              <p className="lg:hidden md:hidden text-xs text-gray-400">Shoes</p>
              <img
                src={img}
                alt="shoes"
            ...
            <div className="col-span-1">
              <p className="lg:hidden md:hidden text-xs text-gray-400">
                Price:
              </p>
              <p className="text-sm font-bold">1234br</p>
            </div>
            ...
            {/* Size */}
            <div className="col-span-1">
              <p className="lg:hidden md:hidden text-xs text-gray-400">Size</p>
            ...
            {/* Date */}
            <div className="">
              <p className="lg:hidden md:hidden text-xs text-gray-400">Date</p>
